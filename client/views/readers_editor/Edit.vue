          ...
          <article class="tile is-child box">
            ...
            <div class="block">
              ...
              <div class="control is-horizontal" v-if="reader.status==3 || reader.reason">
                ...
                <div class="control">
                  <div class="control">
                    <textarea disabled class="textarea" v-model="reader.reason"></textarea>
                  </div>
                </div>
              </div>
              <div class="control is-horizontal">
                ...
                <div class="control">
                  ...
                  <router-link :to="'/readers_editor/list/0'"><button class="button is-link">取消</button></router-link>
                </div>
              </div>
            </div>
          </article>
...
export default {
  ...
  created () {
    ...
    if (id) {
      this.title = '编辑共读'
      this.loading = true
      api.reader.editor.getDetail(this.$route.params.id)
        .then((reader) => {
  ...
  methods: {
    submit () {
      ...
      if (this.id) {
        ...
        api.reader.editor.edit(this.id, this.reader).then((res) => {
          console.log(res)
          this.$router.push('/readers_editor/list/0')
        ...
        api.reader.editor.add(this.reader).then((res) => {
          console.log(res)
          helper.showSuccess('添加成功')
          this.$router.push('/readers_editor/list/0')
        })
    ...
    getList () {
      ...
      params.offset = ''
      params.length = ''
      api.reader.editor.getList(params)
      .then((data) => {
